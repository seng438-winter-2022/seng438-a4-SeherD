...
import java.net.URL;
public class InvalidSignInNoEmailTest {
  ...
  @Test
  public void invalidSignInNoEmail() {
    // Test name: invalidSignInNoEmail
    ...
    // 12 | type | css=.gigya-input-password:nth-child(2) | hithere
    // type random password
    driver.findElement(By.cssSelector(".gigya-input-password:nth-child(2)")).sendKeys("hithere");
    // 13 | click | css=#gigya-login-form .gigya-composite-control-submit > .gigya-input-submit | 
